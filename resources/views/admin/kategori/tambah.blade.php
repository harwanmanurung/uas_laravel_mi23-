...
<div class="row">
    <div class="col-md-3">
        <div class="card glass-card p-3 shadow-lg border-0 mb-4" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(15px);">
            <div class="list-group list-group-flush bg-transparent">
                ...
                <a href="/admin/kategori" class="list-group-item list-group-item-action bg-warning bg-opacity-25 text-warning fw-bold border-warning border-opacity-25 rounded mb-2 shadow-sm">Kategori</a>
    ...
    <div class="col-md-9">
        <div class="card glass-card p-4 shadow-lg border-0" style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(15px); min-height: 500px;">
            <h3 class="fw-bold text-white text-uppercase mb-4">Tambah Kategori Perabotan</h3>
            <hr class="border-warning border-opacity-50 mb-5">
            ...
            <div class="p-4 border border-white border-opacity-25 rounded-3" style="max-width: 600px; background: rgba(0,0,0,0.2);">
                <form action="{{ route('category.store') }}" method="POST">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-md-4">
                            <label class="form-label text-warning fw-bold mb-0">Nama Kategori</label>
                        </div>
                        <div class="col-md-8">
                            <input type="text" name="nama_kategori" class="form-control bg-transparent text-white border-warning border-opacity-50" placeholder="Contoh: Sofa, Meja" required autofocus>
                        </div>
                    </div>

                    <div class="d-flex justify-content-end gap-3 align-items-center mt-5">
                        <a href="/admin/kategori" class="text-warning text-decoration-none fw-bold">Kembali</a>
                        <button type="submit" class="btn btn-outline-warning fw-bold px-4 border-2">Simpan Kategori</button>
                    </div>
                </form>
            </div>
        </div>
